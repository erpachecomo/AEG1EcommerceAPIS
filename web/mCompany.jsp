                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <div class="form-group">
                                                <label class="control-label" for="rolename2">Nombre de la compañia</label>
                                                <div class="input-group">
                                                    <span class="input-group-addon">
                                                        <i class="glyphicon glyphicon-user"></i>
                                                    </span>
                                                    <input class="form-control" id="rolename2" name="rolename2" placeholder="Nombre de la compañia">
                    ...
                    <form id="frmCompany" method="POST">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" id="companyname" name="companyname" placeholder="Nombre de la Compañia">
                            </div>
                        </div>
                        <div class="form-group">
