                            ...
                            <div class="col-lg-10 col-md-10 col-sm-10">
                                ...
                                <div class="form-group col col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type= "email" id="email2" name="email2" placeholder="Correo electrónico">
                                    </div>
                                </div>
                                <div class="form-group col col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <!--label class="control-label" 
                                           for="photo">Fotografía</label-->
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                            <i class="glyphicon glyphicon-camera"></i>
                                        </span>
                                        <input class="form-control" type= "text" id="photo2" name="photo2" placeholder="Fotografía">
                                    </div>
                                </div>
                                <div class="form-group col col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <!--label class="control-label" for="cbCompany">Compañia</label-->
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                ...
                                <div class="form-group col col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <!--label class="control-label" 
                                           for="zip">Código Postal</label-->
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                            <i class="glyphicon glyphicon-barcode"></i>
                                        </span>
                                        <input class="form-control" type= "text" id="zip2" name="zip2" placeholder="Código Postal">
                                    </div>
                                </div>
                                <div class="form-group col col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <!--label class="control-label" 
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type= "text" id="region2" name="region2" placeholder="Región">
                                    </div>
                                </div>
                                <div class="form-group col col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <!--label class="control-label" 
    ...
    <div class="row">
        ...
        <div class="col col-lg-10 col-md-10 col-sm-10 col-xs-10">
            <form id="frmUsr" method="POST">
                ...
                <div class="form-group col col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    <!--label class="control-label" 
                           for="password2">Confirma la contraseña</label-->
                    <div class="input-group">
                        <span class="input-group-addon">
                            <i class="glyphicon glyphicon-lock"></i>
                        </span>
                        <input class="form-control" type= "password" id="password2" name="password2" placeholder="Vuelve a escribir la contraseña">
                    </div>
                </div>
                <div class="form-group col col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    <!--label class="control-label" 
                ...
                <div class="form-group col col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control" type= "text" id="photo" name="photo" placeholder="Fotografía">
                    </div>
                </div>
                <div class="form-group col col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    <!--label class="control-label" for="cbCompany">Compañia</label-->
